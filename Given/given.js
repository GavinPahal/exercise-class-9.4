...
console.log(travelPlaces); // "Toronto", "New york", "Austrlia", "Spain"
...
bakingRecipies.pop();
console.log(bakingRecipies.pop());
...
console.log(`I am taking,` ${schedule[0][3]} ${schedule[1][3]} `that is worth` ${schedule[2][3]} `credits`);
